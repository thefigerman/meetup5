package id.co.plnntb.re100.helper

/**
 * Created by fahrizalmarup on 3/14/16.
 */
    ...
    fun getLocation(): Location? {
        try {
            ...
            if (!isGPSEnabled && !isNetworkEnabled) {
                Log.d(TAG, "No Location service enabled")
            } else {
                ...
                if (isNetworkEnabled) {
                    ...
                    Log.d(TAG, "Network. minimum distance change: " + java.lang.Float.toString(MIN_DISTANCE_CHANGE_FOR_UPDATES.toFloat()))
